				...
				<div class="col-lg-7 d-none d-lg-block">
					<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="carousel-item img-1 min-vh-100 active" style="background-image: url('Recursos/img-1.jpg'); background-size: cover;
							...
							<div class="carousel-item  min-vh-100" style="background-image: url('Recursos/img-2.jpg'); background-size: cover;
 								background-position: center;">
							...
							<div class="carousel-item img-3 min-vh-100" style="background-image: url('Recursos/img-3.jpg'); background-size: cover;
 								background-position: center;">
								<div class="carousel-caption d-none d-md-block">
									<h5 class="font-weight-bold">La más potente del mercado</h5>
									<a class="text-muted text-decoration-none">Visita nuestra tienda</a>
							...
							<div class="carousel-item img-4 min-vh-100" style="background-image: url('Recursos/img-4.jpg'); background-size: cover;
 								background-position: center;">
								<div class="carousel-caption d-none d-md-block">
									<h5 class="font-weight-bold">Descubre la nueva generación</h5>
									<a class="text-muted text-decoration-none">Visita nuestra tienda</a>
